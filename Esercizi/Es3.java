...
public class Es3
{
   public static void main1(){
       ...
       for ( int i = 0; i < n; i++ ){
           for ( int j = 0; j < n; j++ ){
               System.out.print("Inserire l'elemento " + j + " della riga " + i + ": ");
               matrice[i][j] = Tastiera.leggiUnIntero();
           } 
       }
   ...
   public static void main2(){
       ...
       System.out.println("La riga con la sommatoria massiama è: " + rigaMax);
       for ( int i = 0; i < n; i++ ){
           for ( int j = 0; j < n; j++ ){
               if ( j == n-1 ){
                   System.out.println(matrice[i][j]);
   ...
   public static void main4(){
       ...
       for ( int i = 0; i < n; i++ ){
           for ( int j = 0; j < 12; j++ ){
               System.out.print("Inserire le vendite del prodotto " + i + " nel mese " + (j+1) + ": ");
               matrice[i][j] = Tastiera.leggiUnIntero();
           } 
       }
       for ( int i = 0; i < n; i++ ){
